...
const LetterGlitch = ({
  ...
  const hexToRgb = (hex: string): Rgb | null => {
    ...
    const full = hex.replace(shorthandRegex, (_m, r: string, g: string, b: string) => {
      return r + r + g + g + b + b;
    });
  ...
  const parseToRgb = (color: string): Rgb | null => {
  ...
  const handleSmoothTransitions = () => {
    ...
    letters.current.forEach((letter) => {
      if (letter.colorProgress < 1) {
        ...
        const startRgb = parseToRgb(letter.color);
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- canvas loop; glitchSpeed/smooth drive behavior
  }, [glitchSpeed, smooth]);
  ...
  return (
    <div style={containerStyle} className={className}>
      ...
      {outerVignette ? <div style={outerVignetteStyle} aria-hidden /> : null}
      {centerVignette ? <div style={centerVignetteStyle} aria-hidden /> : null}
    </div>
  );
};
